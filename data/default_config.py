...
class GlyceEmbeddingConfig(object):
    def __init__(self, dropout, idx2word, idx2char,word_embsize,glyph_embsize,font_channels,random_fonts,font_name,font_size,use_tranditional,font_normalize,subchar_type,subchar_embsize):
